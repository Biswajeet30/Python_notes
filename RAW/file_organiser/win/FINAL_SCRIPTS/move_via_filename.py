...
source_folder = r"E:\sorted Youtube vids 2023_2024\YT2024\BHARAT"
### changeable  target folder as per operations
target_folder = r"E:\sorted Youtube vids 2023_2024\2024\Ram Mandir"
new_directory = r"E:\sorted Youtube vids 2023_2024\2024\Ram Mandir\logs"
report_transferred_files_logFILE_path = r"E:\sorted Youtube vids 2023_2024\2024\Ram Mandir\logs\transferred_files_log.txt"
report_remaining_files_logFILE_path = r"E:\sorted Youtube vids 2023_2024\2024\Ram Mandir\logs\remaining_files_log.txt"
...
def find_and_sort_videos_by_filename(folder_path):
    ...
    for item in os.listdir(folder_path):
        ...
        # ### changeable  string as per operations  or "Iyer Mitra" or "Chavda "
        contains_india = "Ram Mandir" in item                                                    
...
def move_videos_with_india(source_folder, target_folder, log_file):
    ...
    for item in os.listdir(source_folder):
        ...
        ### changeable  string as per operations
        # contains_india = "India" in item  or "Iyer Mitra" or "Chavda "
        contains_india = "Ram Mandir" in item
